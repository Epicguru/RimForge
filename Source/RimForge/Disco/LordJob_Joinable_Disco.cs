...
namespace RimForge.Disco
{
    public class LordJob_Joinable_Disco : LordJob_Joinable_Gathering
    {
        ...
        protected virtual ThoughtDef AttendeeThought => RFDefOf.RF_AttendedDiscoThought;
        protected virtual TaleDef AttendeeTale => RFDefOf.RF_AttendedDiscoTale;
        protected virtual ThoughtDef OrganizerThought => RFDefOf.RF_AttendedDiscoThought;
        protected virtual TaleDef OrganizerTale => RFDefOf.RF_AttendedDiscoTale;
        ...
        public override void ExposeData()
        {
            ...
            this.gatheringDef = RFDefOf.RF_DiscoGathering;
        }
    }
}
